[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Architects+Daughter&color=7AF79A&size=30&lines=Hey!+It's+Maleesha+Indunil!;Backend+Engineer+in+Progress...;Cloud+%7C+DevSecOps+%7C+AI+Aware+Developer)](https://git.io/typing-svg)
...
- 🔐 Interested in DevSecOps & Application Security  
- 🤖 AI-aware Developer building AI-integrated systems  
- ⚙️ Automation builder using n8n & modern workflows  
- 🏗️ I build scalable web apps, APIs, and system-driven projects  
- 🧩 Organizer – Inter-university CTF (Medusa 2.0)
...
- ✅ Mastering Backend Engineering (Spring Boot, Node.js, FastAPI)
...
![EDA](https://img.shields.io/badge/Data%20Analysis-4B8BBE?style=for-the-badge)
...
- 🏗️ Build production-level SaaS projects
